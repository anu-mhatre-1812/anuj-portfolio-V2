 ...
 */
const PaperAirplane = ({ position = [0, 0, 0], rotation = [0, 0, 0], scale = 1, color = '#F5F1E8' }) => {
    ...
    return (
        <group position={position} rotation={rotation} scale={scale}>
            {/* Shadow layer (taupe) */}
            <mesh geometry={geometry} position={[0.05, -0.08, 0.05]}>
                <meshBasicMaterial
                    color="#B8B0A3"
            ...
            {/* Highlight layer (white) */}
            <mesh geometry={geometry} position={[-0.03, 0.06, -0.03]}>
                <meshBasicMaterial
                    color="#FFFFFF"
                    side={THREE.DoubleSide}
                    transparent
